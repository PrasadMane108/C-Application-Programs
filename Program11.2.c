/*Accept N numbers from user andaccept one another
 number NO and return index of first occurance of that NO.
Input:    N         5   AND NO = 33       N = 4 AND NO =108            4
        elements: 85 33 10 33 11         200  436  118 125
Output:            1                         ERR_NOTFOUND         
*/
...
int FirstOccur(int Arr[], int iLength, int iNo)//step 5:Apply logic to perform operatons
{
    int iCnt = 0;
